...
const translations = {
  en: {
    ...
    'cooperative.subtitle': 'Generate cooperative registration certificate',
    'cooperative.certificatePreview': 'Certificate Preview',
    'cooperative.certificatePreviewDesc': 'Sample cooperative registration data',
  ...
  lo: {
    ...
    'cooperative.subtitle': 'ສ້າງໃບທະບຽນລົງທະບຽນສະຫະກອນ',
    'cooperative.certificatePreview': 'ຕົວຢ່າງໃບທະບຽນ',
    'cooperative.certificatePreviewDesc': 'ຂໍ້ມູນຕົວຢ່າງການລົງທະບຽນສະຫະກອນ',
